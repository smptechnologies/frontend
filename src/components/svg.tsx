  ...
  return (
    ...
    >
      ...
      <svg
        ...
        x="0"
        y="0"
        viewBox="115 84.56 110.000000 80.880000"
      ...
      >
        ...
        <g
          ...
          transform="translate(140,84.10354995727539)"
        >
          <g>
            <rect
              fill="#333"
            ...
            <svg
              ...
              width="60"
              height="81.79290037624735"
              filter="colorsb4316909985"
              className="image-svg-svg primary"
              style={{ overflow: "visible" }}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0.0015106201171875 0 83.56697082519531 113.91999816894531"
              >
                <g fillRule="evenodd">
                  <path
                    d="M62.42 32l-5.69-5.69L32.78 50.3c-16.3 16.3-7.26 36 6.52 49.73l5.7 5.69 23.94-23.94C85.24 65.47 76.2 45.83 62.42 32zM28.68 46.2l28.05-28.05 9.79 9.79c16 16 25.53 38.92 6.52 57.94L45 113.92l-9.79-9.79c-16.01-16-25.54-38.92-6.53-57.93z"
                    fill="#0b75d2"
                  />
                  <path
                    d="M53.34 23l-5.69-5.68-23.94 23.9C7.4 57.52 16.44 77.17 30.23 91l5.69 5.69 23.94-24C76.17 56.4 67.13 36.75 53.34 23zM19.61 37.12l28-28 9.79 9.78C73.45 34.87 83 57.79 64 76.8l-28 28.05-9.79-9.79C10.12 79.05.59 56.14 19.61 37.12z"
                    fill="#00a9ff"
                  />
                  <path
                    d="M44.27 13.89L38.58 8.2l-23.95 24c-16.3 16.3-7.26 35.95 6.52 49.73l5.69 5.69 24-23.94c16.3-16.31 7.26-35.95-6.52-49.74zM10.53 28.05L38.58 0l9.79 9.79c16 16 25.53 38.92 6.52 57.94l-28 28L17.05 86c-16-16-25.53-38.94-6.52-57.95z"
                    fill="#52cdff"
                  />
                </g>
              </svg>
...
export function LogoWithText() {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      xmlnsXlink="http://www.w3.org/1999/xlink"
      className="relative w-36 h-36 lg:-left-4 lg:-top-7"
    >
      <rect
        y="0"
        x="0"
      ...
      >
        ...
        <g
          ...
          transform="translate(87.59979248046875,69.99354934692383)"
        >
          <g
            className="iconsvg-imagesvg"
            transform="translate(52.40020751953125,0)"
          >
            <g>
              <rect
                fill="#333"
...
export function Linkedin() {
  return (
    <svg
      ...
      height="16"
      fill="currentColor"
      className="bi bi-linkedin hover:text-gray-900"
      viewBox="0 0 16 16"
    >
...
export function Email() {
  return (
    <svg
      ...
      height="16"
      fill="currentColor"
      className="bi bi-envelope-fill hover:text-gray-900"
      viewBox="0 0 16 16"
    >
